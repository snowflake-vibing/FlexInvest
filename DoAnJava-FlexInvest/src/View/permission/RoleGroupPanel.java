...
public class RoleGroupPanel extends JPanel {
    ...
    private JPanel buildGroupPanel() {
        ...
        View.UIUtils.styleTable(groupTable);
        ...
        JButton btnAdd = btnSmall("+ Thêm", GREEN);
        JButton btnEdit = btnSmall("Sửa", BLUE);
        JButton btnDel  = btnSmall("Xóa", RED);
    ...
    private JPanel buildAssignPanel() {
        ...
        JButton btnAll   = btnSmall("Chọn tất cả",    GREEN);
        JButton btnNone  = btnSmall("Bỏ chọn",        RED);
    ...
    private void openGroupDialog(RoleGroup existing) {
        ...
        JButton save = btn("Lưu", BLUE), cancel = btn("Hủy", TEXT_MUTED);
