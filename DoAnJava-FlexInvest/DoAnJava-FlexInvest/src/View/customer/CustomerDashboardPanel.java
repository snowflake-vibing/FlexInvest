    ...
    public void loadData() {
        ...
        new SwingWorker<Object[], Void>() {
            ...
            protected Object[] doInBackground() {
                ...
                List<SavingsProduct> products = investDAO.getAllActiveProducts();
                return new Object[]{wallet, total, soon, kyc, products};
            }
            ...
            protected void done() {
                try {
                    ...
                    @SuppressWarnings("unchecked")
                    List<SavingsProduct> products = (List<SavingsProduct>) data[4];

                    Map<Integer, SavingsProduct> prodMap = new HashMap<>();
                    if (products != null) products.forEach(p -> prodMap.put(p.getProductId(), p));
                    ...
                    for (Investment inv : soon) {
                        ...
                        SavingsProduct prod = prodMap.get(inv.getProductId());
                        String productName = (prod != null) ? prod.getProductName() : "Gói #" + inv.getProductId();
    ...
    private void updateKycBanner(Ekyc kyc) {
        ...
        if (showBtn) {
            ...
            btn.addActionListener(e -> {
                Frame parentFrame = (Frame) SwingUtilities.getWindowAncestor(CustomerDashboardPanel.this);
                EkycDialog.show(parentFrame, account);
                loadData();
            });
