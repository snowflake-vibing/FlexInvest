...
public class WalletPanel extends JPanel {
    ...
    private static final String[] TYPE_CODES  = {"ALL", "DEPOSIT", "WITHDRAW", "INVEST", "PAYOUT", "BONUS"};
    private static final String[] TYPE_LABELS = {"Tất cả", "Nạp tiền", "Rút tiền", "Đầu tư", "Nhận lãi", "Thưởng"};
    ...
    private JPanel buildContent() {
        ...
        cbType = new JComboBox<>(TYPE_CODES);
        cbType.setRenderer(new javax.swing.DefaultListCellRenderer() {
            @Override
            public java.awt.Component getListCellRendererComponent(
                ...
                for (int i = 0; i < TYPE_CODES.length; i++) {
                    if (TYPE_CODES[i].equals(value)) { setText(TYPE_LABELS[i]); break; }
                }
                return this;
            }
        });
    ...
    private void applyFilter() {
        ...
        filteredTx = allTx.stream().filter(tx -> {
            // Type filter
            if (!"ALL".equals(typeFilter) && !typeFilter.equals(tx.getTypeCode()))
                return false;
            // Date filter
    ...
    static class TxTableModel extends AbstractTableModel {
        private static final String[] COLS = {
            "Ngày giờ", "Loại", "Số tiền (VNĐ)", "Trạng thái"
        };
